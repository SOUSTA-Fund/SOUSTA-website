...
const IndexPage = () => {
  return (
    <Layout>
      <header
        style={{
          background: 'linear-gradient(150deg, #ffffff 0%, #7a83a3 100%)',
        }}
      >
        <div
        ...
        >
          <div className="flex flex-col justify-center min-h-screen relative px-8 py-24 lg:grid lg:grid-cols-4 lg:px-24">
            <div className="relative col-span-3 flex flex-col justify-center">
              <h1 className="z-10 leading-tight mb-4 text-3xl md:text-5xl lg:text-7xl">
                Profit From Our Experience
              </h1>
              <p className="text-gray-600 z-10 md:text-2xl">
